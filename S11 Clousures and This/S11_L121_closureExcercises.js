/* Write a function called specialMultiply which accepts two parameters.
   ...
   later be passed another parameter to return the product. You will have to use closure and arguments to solve this.
...
/* Write a function called guessingGame which takes in one parameter amount.
   ...
   You should stop the user from guessing if the amount of guesses they have made is greater than the initial
