...
console.log(tripleAndFilter([1, 2, 3, 4, 5, 10, 15]));
...
console.log(doubleOddNumbers([1, 2, 3, 4, 5, 10, 15]));
...
console.log(mapFilterAndReduce([{firstName: "alf"}]));
...
console.log(createStudentObj("alex", "diaz"));
